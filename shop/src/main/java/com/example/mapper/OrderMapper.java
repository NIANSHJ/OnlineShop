...
public interface OrderMapper {
    ...
    //添加订单
    @Insert("insert into order_goods(order_id,goods_id,goods_name,price,count,create_time)" +
            "values(#{orderId},#{cartItem.goodsId},#{cartItem.goodsName},#{cartItem.price},#{cartItem.count},now())")
