...
public class RedisUtil {
     ...
     * @return 值
     */
    public <T> T hashMultiGet(String key, Collection items) {
        return (T) redisTemplate.opsForHash().multiGet(key, items);
    }
     ...
     * @param time 时间(秒)
     */
    public void hashSetAll(String key, Map<String, Object> map, long time) {
        redisTemplate.opsForHash().putAll(key, map);
        expire(key, time);
    }
